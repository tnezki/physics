...
# =============================================================================
# UNIT 4 SUMMATIVE GRAPH GENERATION CALLS — appended after authoritative source
# =============================================================================

def _u4_sum_bar(filename, values):
    fig, ax = plt.subplots(figsize=(5.2, 3.0))
    fig.patch.set_facecolor('white')
    cats=['A GPE','A KE','A Thermal','B GPE','B KE','B Thermal']
    make_bar_chart(ax, cats, values, title='', ylabel='Energy (J)', xlabel='')
    save_graph(fig, filename)
    plt.close(fig)

_u4_sum_bar('u4_summative_energy_v1.png',[80,20,0,20,80,0])
_u4_sum_bar('u4_summative_energy_v2.png',[70,10,0,10,70,0])
_u4_sum_bar('u4_summative_energy_v3.png',[0,60,0,0,15,45])
_u4_sum_bar('u4_summative_energy_v4.png',[90,10,0,25,50,25])
_u4_sum_bar('u4_summative_energy_v5.png',[75,25,0,15,85,0])
_u4_sum_bar('u4_summative_energy_v6.png',[60,20,0,10,50,20])
_u4_sum_bar('u4_summative_energy_v7.png',[0,90,0,0,30,60])
_u4_sum_bar('u4_summative_energy_v8.png',[85,15,0,20,80,0])
