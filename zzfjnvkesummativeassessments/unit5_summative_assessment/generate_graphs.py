...
# =============================================================================
# UNIT 5 SUMMATIVE — APPENDED GRAPH GENERATION CALLS
# =============================================================================

def _u5_resonance_graph(filename, freqs, responses):
    fig, ax = plt.subplots(figsize=(3.5, 2.4))
    fig.patch.set_facecolor('white')
    make_bar_chart(ax, [str(x) for x in freqs], responses,
                   title='', ylabel='Response amplitude',
                   xlabel='Driving frequency (Hz)')
    save_graph(fig, filename)
    plt.close(fig)

_u5_resonance_graph('u5_summative_resonance_v1.png', [3, 4, 5, 6, 7], [1.0, 2.0, 4.7, 8.4, 4.9])
_u5_resonance_graph('u5_summative_resonance_v2.png', [2, 3, 4, 5, 6], [1.1, 2.3, 7.8, 4.1, 2.0])
_u5_resonance_graph('u5_summative_resonance_v3.png', [4, 5, 6, 7, 8], [1.2, 3.8, 8.1, 4.0, 1.7])
_u5_resonance_graph('u5_summative_resonance_v4.png', [5, 6, 7, 8, 9], [1.0, 2.4, 5.0, 8.6, 4.6])
_u5_resonance_graph('u5_summative_resonance_v7.png', [4.0, 4.5, 5.0, 5.5, 6.0], [1.4, 3.0, 7.9, 4.0, 1.8])
_u5_resonance_graph('u5_summative_resonance_v8.png', [5.0, 5.5, 6.0, 6.5, 7.0], [1.2, 3.1, 8.3, 4.2, 1.9])
