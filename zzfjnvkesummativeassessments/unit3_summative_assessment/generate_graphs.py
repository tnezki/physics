...
# =============================================================================
# UNIT 3 SUMMATIVE GRAPH GENERATION CALLS — appended after authoritative source
# =============================================================================

def _u3_terminal_graph(filename, vt, tau, xmax):
    fig, ax = plt.subplots(figsize=(5.0, 3.0))
    fig.patch.set_facecolor('white')
    fn = {
        'expr': lambda t, vt=vt, tau=tau: vt*(1-np.exp(-t/tau)),
        'deriv': lambda t, vt=vt, tau=tau: (vt/tau)*np.exp(-t/tau),
        'color': 'steelblue',
        'label': None
    }
    make_context_graph(ax, [fn], 0, xmax, 0, vt*1.15, xlabel='Time (s)', ylabel='Speed (m/s)', title='')
    save_graph(fig, filename)
    plt.close(fig)

_u3_terminal_graph('u3_sum_q14_v1.png', 42, 1.1, 8)
_u3_terminal_graph('u3_sum_q14_v2.png', 30, 0.9, 8)
_u3_terminal_graph('u3_sum_q14_v3.png', 55, 1.3, 9)
_u3_terminal_graph('u3_sum_q14_v4.png', 36, 1.0, 8)
_u3_terminal_graph('u3_sum_q14_v5.png', 48, 1.2, 9)
_u3_terminal_graph('u3_sum_q14_v6.png', 28, 0.8, 7)
_u3_terminal_graph('u3_sum_q14_v7.png', 60, 1.5, 10)
_u3_terminal_graph('u3_sum_q14_v8.png', 40, 1.0, 9)
