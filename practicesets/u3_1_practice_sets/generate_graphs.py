...
# --- Unit 3.1 practice-set graph ---
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_context_graph(ax,[{'expr':lambda x:0.5*x,'deriv':lambda x:np.full_like(x,0.5,dtype=float),'color':'steelblue','label':None}],0,20,0,10,xlabel='Net Force (N)',ylabel='Acceleration (m/s²)',title='')
save_graph(fig,'p1_force_accel.png'); plt.close(fig)
