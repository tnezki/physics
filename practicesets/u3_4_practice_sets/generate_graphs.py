...
# UNIT 3 SECTION 3.4 PRACTICE-SET GRAPH
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_bar_chart(ax,['Object A\n2 kg','Object B\n8 kg'],[12,3],title='Same Interaction-Force Magnitude',xlabel='Object',ylabel='Acceleration (m/s^2)')
save_graph(fig,'u3_ps_s4_equal_force_accel_sq_v1.png')
plt.close(fig)
