...
# Unit 5.5 practice graph: beat rate tracks frequency difference
fig, ax = plt.subplots(figsize=(4,3))
make_bar_chart(ax,['1','2','4','6','8'],[1,2,4,6,8],ylabel='Beat rate (beats/s)',xlabel='Frequency difference (Hz)',title='')
save_graph(fig,'p2_beat_rate.png')
plt.close(fig)
