...
# Unit 6.1 appended graph code
fig, ax = plt.subplots(figsize=(4.4, 3.2))
make_context_graph(ax,[{'expr':lambda x: 3000.0/x,'deriv':lambda x: -3000.0/(x**2),'color':'steelblue','label':None}],xmin=400,xmax=700,ymin=4.0,ymax=7.5,xlabel='Wavelength (nm)',ylabel='Frequency (10^14 Hz)',title='Visible-light relationship')
save_graph(fig,'p1_visible_relation.png')
plt.close(fig)
