...
# UNIT 1 SECTION 1.3 PRACTICE-SET GRAPH
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_bar_chart(ax,['T1 R','T1 L','T2 R','T2 L','T3 R','T3 L'],[20,20,35,15,25,40],title='Horizontal Force Trials',xlabel='Force entry',ylabel='Force Magnitude (N)')
save_graph(fig,'u1_ps_s3_force_trials_bar_sq_v1.png')
plt.close(fig)
