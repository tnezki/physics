...
# UNIT 1 SECTION 1.2 PRACTICE-SET GRAPH
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_context_graph(ax,[{'expr':lambda x:np.full_like(x,3.0),'deriv':lambda x:np.zeros_like(x),'color':'steelblue'}],xmin=0,xmax=10,ymin=0,ymax=6,xlabel='Time (s)',ylabel='Velocity (m/s)',title='Velocity Over Time')
save_graph(fig,'u1_ps_s2_velocity_constant_sq_v1.png')
plt.close(fig)
