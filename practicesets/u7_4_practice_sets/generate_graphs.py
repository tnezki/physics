...
# Unit 7.4 practice graph
fig, ax = plt.subplots(figsize=(4.0,3.0))
make_bar_chart(ax,['A','B','C','D'],[300,240,500,180],title='Daily Electrical Energy',ylabel='Energy (Wh)',xlabel='Device')
save_graph(fig,'p1_energy_bar.png')
plt.close(fig)
