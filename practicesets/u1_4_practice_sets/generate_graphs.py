...
# UNIT 1 SECTION 1.4 PRACTICE-SET GRAPH
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_scatter_plot(ax,[100,200,300,400,500],[100,200,300,400,500],0,550,0,550,line_of_best_fit=True,xlabel='Weight (N)',ylabel='Support Force (N)',title='Equilibrium Cases')
save_graph(fig,'u1_ps_s4_support_weight_sq_v1.png')
plt.close(fig)
