...
# Unit 7.3 practice graph
fig, ax = plt.subplots(figsize=(4.0,3.0))
make_context_graph(ax,[{'expr':lambda x: 5*x,'deriv':lambda x: np.full_like(x,5.0),'color':'steelblue','label':None}],xmin=0,xmax=4,ymin=0,ymax=20,xlabel='Current (A)',ylabel='Voltage (V)',title='Device A')
save_graph(fig,'p1_ohm_graph.png')
plt.close(fig)
