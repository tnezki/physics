...
# Unit 5.4 practice graph: resonance response scan
fig, ax = plt.subplots(figsize=(4,3))
make_bar_chart(ax,['2','4','6','8','10'],[1.0,2.0,6.5,2.2,1.1],ylabel='Response amplitude (cm)',xlabel='Driving frequency (Hz)',title='')
save_graph(fig,'p2_resonance_scan.png')
plt.close(fig)
