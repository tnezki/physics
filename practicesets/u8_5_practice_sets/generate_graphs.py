...
# UNIT 8.5 PRACTICE-SET GRAPH GENERATION
if __name__ == "__main__":
    fig, ax = plt.subplots(figsize=(4,3))
    make_context_graph(ax, [
        {"expr": lambda x: 0.2*x, "deriv": lambda x: np.zeros_like(x)+0.2, "color": "steelblue", "label": None}
    ], xmin=0, xmax=600, ymin=0, ymax=120, xlabel="Secondary turns", ylabel="Secondary voltage (V)", title="20 V primary, 100 primary turns")
    save_graph(fig, "transformer_voltage_turns.png")
    plt.close(fig)
