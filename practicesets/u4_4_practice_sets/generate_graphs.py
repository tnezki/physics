...
# --- Unit 4.4 energy-account graph ---
fig, ax = plt.subplots(figsize=(4,3))
make_bar_chart(ax,['PE','KE','Thermal'],[45,40,15],title='',ylabel='Energy (J)',xlabel='Energy form')
save_graph(fig,'p1_energy_account.png'); plt.close(fig)
