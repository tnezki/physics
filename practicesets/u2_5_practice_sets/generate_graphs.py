...
# --- Unit 2.5 practice-set graphs ---
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_context_graph(ax,[{'expr':lambda x:x*x,'deriv':lambda x:2*x,'color':'steelblue','label':None}],0,4,0,16,xlabel='Time (s)',ylabel='Distance (m)',title='')
save_graph(fig,'p2_distance_time.png'); plt.close(fig)
