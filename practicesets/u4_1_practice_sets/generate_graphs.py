...
# UNIT 4 SECTION 4.1 PRACTICE-SET GRAPHS
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_bar_chart(ax,['A','B','C'],[12,8,10],title='Momentum Comparison',ylabel='Momentum (kg m/s)',xlabel='Object')
save_graph(fig,'u4_ps_s1_momentum_compare_sq_v1.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5,3.5))
make_bar_chart(ax,['Short stop','Long stop'],[800,200],title='Average Force for the Same Momentum Change',ylabel='Average Force (N)',xlabel='Stopping situation')
save_graph(fig,'u4_ps_s1_contact_force_sq_v1.png')
plt.close(fig)
