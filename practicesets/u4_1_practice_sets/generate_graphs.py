...
# --- Unit 4.1 practice-set quantitative graph ---
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_scatter_plot(ax,[1,2,3,4,5],[4,8,12,16,20],0,5,0,20,color='steelblue',line_of_best_fit=True,xlabel='Mass (kg)',ylabel='Momentum (kg·m/s)',title='')
save_graph(fig,'p1_momentum_mass.png'); plt.close(fig)
