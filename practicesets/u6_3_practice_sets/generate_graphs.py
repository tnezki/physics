...
# Unit 6.3 appended graph code
fig, ax = plt.subplots(figsize=(4.4, 3.2))
make_context_graph(ax,[{'expr':lambda x: 3.0/x,'deriv':lambda x: -3.0/(x**2),'color':'steelblue','label':None}],xmin=1.0,xmax=2.0,ymin=1.5,ymax=3.0,xlabel='Index of refraction, n',ylabel='Light speed (10^8 m/s)',title='Index and light speed')
save_graph(fig,'p2_speed_index.png')
plt.close(fig)
