...
# UNIT 1 SECTION 1.1 PRACTICE-SET GRAPHS
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_scatter_plot(ax,[20,30,40,50,60],[0.90,1.08,1.24,1.41,1.58],0,70,0,2.0,line_of_best_fit=True,xlabel='Pendulum Length (cm)',ylabel='Period (s)',title='Pendulum Measurements')
save_graph(fig,'u1_ps_s1_pendulum_scatter_sq_v1.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5,3.5))
make_scatter_plot(ax,[1,2,3,4,5],[10.0,10.2,9.9,15.8,10.1],0,6,8,17,line_of_best_fit=False,xlabel='Trial',ylabel='Measured Length (cm)',title='Repeated Measurements')
save_graph(fig,'u1_ps_s1_outlier_scatter_sq_v1.png')
plt.close(fig)
