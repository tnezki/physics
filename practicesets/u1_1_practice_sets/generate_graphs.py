...
# =============================================================================
# UNIT 1.1 PRACTICE SET FIGURES — APPENDED GENERATION BLOCKS
# =============================================================================
if __name__ == '__main__':
    ...
    make_bar_chart(
        ...
        [24, 20, 17, 15],
        title='Recorded Shadow Lengths',
        ylabel='Shadow Length (cm)',
        xlabel='Time'
    )
    save_graph(fig, 'p1_q6_shadow_lengths.png')
    plt.close(fig)
    ...
    make_scatter_plot(
        ...
        [0.0, 0.1, 0.2, 0.3, 0.4],
        [0.0, 0.4, 1.6, 3.6, 6.4],
        xmin=0.0, xmax=0.4, ymin=0.0, ymax=6.5,
        xlabel='Time (s)', ylabel='Position (m)',
        title='Recorded Ball Position'
    )
    save_graph(fig, 'p2_q6_ball_position.png')
    plt.close(fig)
    ...
    make_scatter_plot(
        ax,
        [1, 2, 3, 4, 5],
        [14.8, 15.1, 14.9, 15.0, 15.2],
        xmin=1, xmax=5, ymin=14.5, ymax=15.5,
        xlabel='Trial', ylabel='Measured Length (cm)',
        title='Repeated Measurements'
    )
    save_graph(fig, 'extra_q9_repeated_measurements.png')
    plt.close(fig)
