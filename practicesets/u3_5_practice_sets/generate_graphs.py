...
# --- Unit 3.5 supplemental projectile graph ---
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_context_graph(ax,[{'expr':lambda x:8+0.8*x-0.08*x*x,'deriv':lambda x:0.8-0.16*x,'color':'steelblue','label':None}],0,10,0,11,xlabel='Horizontal position (m)',ylabel='Height (m)',title='')
save_graph(fig,'projectile_path_graph.png'); plt.close(fig)
