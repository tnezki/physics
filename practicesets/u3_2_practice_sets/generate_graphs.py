...
# --- Unit 3.2 practice-set graph ---
fig, ax = plt.subplots(figsize=(4,3))
make_bar_chart(ax,['Applied','Friction'],[70,25],title='',ylabel='Force magnitude (N)',xlabel='')
save_graph(fig,'p1_applied_friction.png'); plt.close(fig)
