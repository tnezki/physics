...
# UNIT 3 SECTION 3.2 PRACTICE-SET GRAPH
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_bar_chart(ax,['10','20','30','40','50','60'],[10,20,30,40,30,30],title='Friction Across Trials',xlabel='Applied Force Trial (N)',ylabel='Friction Force (N)')
save_graph(fig,'u3_ps_s2_friction_bar_sq_v1.png')
plt.close(fig)
