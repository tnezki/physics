...
# Unit 5.3 practice graph: source-grounded relative sound-speed ordering
fig, ax = plt.subplots(figsize=(4,3))
make_bar_chart(ax,['Gas','Liquid','Solid'],[1,2,3],ylabel='Relative speed index',xlabel='Medium type',title='')
save_graph(fig,'p2_sound_speed_medium.png')
plt.close(fig)
