...
# --- Unit 4.3 kinetic-energy comparison graph ---
fig, ax = plt.subplots(figsize=(4,3))
make_bar_chart(ax,['1','2','3','4'],[1,4,9,16],title='',ylabel='Relative kinetic energy',xlabel='Speed (relative units)')
save_graph(fig,'p1_ke_speed.png'); plt.close(fig)
