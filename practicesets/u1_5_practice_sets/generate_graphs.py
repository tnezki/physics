...
# UNIT 1 SECTION 1.5 PRACTICE-SET GRAPHS
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_bar_chart(ax,['Tile','Carpet'],[12,25],title='Constant-Speed Pulls',xlabel='Surface',ylabel='Pull Force (N)')
save_graph(fig,'u1_ps_s5_surface_pull_bar_sq_v1.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5,3.5))
make_scatter_plot(ax,[1,2,3,4,5,6],[5.0,5.1,5.0,8.2,5.2,5.1],0,7,4,9,line_of_best_fit=False,xlabel='Trial',ylabel='Recorded Value',title='Repeated Trials')
save_graph(fig,'u1_ps_s5_trial_scatter_sq_v1.png')
plt.close(fig)
