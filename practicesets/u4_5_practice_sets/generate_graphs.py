...
# --- Unit 4.5 output-energy graph ---
fig, ax = plt.subplots(figsize=(4,3))
make_bar_chart(ax,['Useful','Thermal'],[72,28],title='',ylabel='Output energy (J)',xlabel='Output category')
save_graph(fig,'p1_output_energy.png'); plt.close(fig)
