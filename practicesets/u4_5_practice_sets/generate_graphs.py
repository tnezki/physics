...
# UNIT 4 SECTION 4.5 PRACTICE-SET GRAPHS
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_bar_chart(ax,['Useful','Thermal/other'],[72,28],title='Energy Outputs from a Device',ylabel='Energy (J)',xlabel='Output category')
save_graph(fig,'u4_ps_s5_useful_thermal_sq_v1.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5,3.5))
make_bar_chart(ax,['Source A','Source B','Source C'],[65,78,72],title='Useful Output in Example Trials',ylabel='Useful output (arb. units)',xlabel='Source trial')
save_graph(fig,'u4_ps_s5_source_output_sq_v1.png')
plt.close(fig)
