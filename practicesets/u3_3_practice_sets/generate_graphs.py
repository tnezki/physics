...
# --- Unit 3.3 practice-set graph ---
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_context_graph(ax,[{'expr':lambda x:50*(1-np.exp(-x/2.0)),'deriv':lambda x:25*np.exp(-x/2.0),'color':'steelblue','label':None}],0,10,0,55,xlabel='Time (s)',ylabel='Speed (m/s)',title='')
save_graph(fig,'p1_falling_speed.png'); plt.close(fig)
