...
# Unit 7.1 practice graph
fig, ax = plt.subplots(figsize=(4.0,3.0))
make_context_graph(ax,[{'expr':lambda x: 16/(x**2),'deriv':lambda x: -32/(x**3),'color':'steelblue','label':None}],xmin=1,xmax=4,ymin=0,ymax=16,xlabel='Separation (relative units)',ylabel='Force (relative units)',title='Electric Force vs. Separation')
save_graph(fig,'p1_force_distance.png')
plt.close(fig)
