...
# --- Unit 2.4 practice-set graphs ---
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_context_graph(ax,[{'expr':lambda x:5*x*x,'deriv':lambda x:10*x,'color':'steelblue','label':None}],0,4,0,80,xlabel='Time (s)',ylabel='Distance fallen (m)',title='')
save_graph(fig,'p2_freefall_distance.png'); plt.close(fig)
