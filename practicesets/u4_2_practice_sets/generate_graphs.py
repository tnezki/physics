...
# UNIT 4 SECTION 4.2 PRACTICE-SET GRAPHS
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_bar_chart(ax,['Before','After'],[15,15],title='Total System Momentum',ylabel='Momentum (kg m/s)',xlabel='State')
save_graph(fig,'u4_ps_s2_before_after_momentum_sq_v1.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5,3.5))
make_bar_chart(ax,['T1 before','T1 after','T2 before','T2 after','T3 before','T3 after'],[12,11,15,15,18,20],title='Measured Collision Trials',ylabel='Momentum (kg m/s)',xlabel='Measurement')
save_graph(fig,'u4_ps_s2_trials_momentum_sq_v1.png')
plt.close(fig)
