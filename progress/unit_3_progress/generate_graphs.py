...
# =============================================================================
# PROGRESS TRACKER FIGURES - UNIT 3
# =============================================================================
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(
    ax,
    [{
        'expr': lambda x: 3.2 - 0.5*9.8*(x/3.0)**2,
        'deriv': lambda x: -(9.8/9.0)*x,
        'color': 'steelblue',
        'label': None,
    }],
    xmin=0, xmax=2.5, ymin=0, ymax=3.2,
    xlabel='Horizontal distance (m)', ylabel='Height (m)',
    title='Ball leaving a table horizontally'
)
save_graph(fig, 'u3_pt_projectile_path_01.png')
plt.close(fig)
