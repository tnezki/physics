...
# =============================================================================
# PROGRESS TRACKER FIGURES - UNIT 5
# =============================================================================
fig, ax = plt.subplots(figsize=(3.5, 3.0))
make_context_graph(
    ax,
    [{
        'expr': lambda x: 1.4*np.sin((np.pi/2)*x),
        'deriv': lambda x: 1.4*(np.pi/2)*np.cos((np.pi/2)*x),
        'color': 'steelblue',
        'label': None,
    }],
    xmin=0, xmax=8, ymin=-2, ymax=2,
    xlabel='Position (m)', ylabel='Displacement',
    title='Wave profile'
)
save_graph(fig, 'u5_pt_wave_profile_01.png')
plt.close(fig)
