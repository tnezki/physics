...
# =============================================================================
# UNIT 3 EXIT TICKET GRAPH GENERATION BLOCKS
# =============================================================================

def _unit3_exit_graphs():
    graphs = [
        ('u3_1_b_accel_force.png', lambda x: x/4.0, lambda x: np.full_like(x, 0.25), 0, 24, 0, 7, 'Net Force (N)', 'Acceleration (m/s^2)', 'Acceleration vs. Net Force'),
        ('u3_3_b_speed_time.png', lambda x: 20*(1-np.exp(-0.7*x)), lambda x: 14*np.exp(-0.7*x), 0, 8, 0, 22, 'Time (s)', 'Speed (m/s)', 'Speed vs. Time'),
    ]
