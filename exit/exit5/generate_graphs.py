...
# =============================================================================
# UNIT 5 EXIT TICKET GRAPH GENERATION
# Appended below the authoritative source; no code above was modified.
# =============================================================================
...
if __name__ == '__main__':
    ...
    make_scatter_plot(
        ...
        ylabel='Response amplitude (cm)',
        title='Response vs. Driving Frequency'
    )
    save_graph(fig, 'u5_4_resonance_response.png')
    plt.close(fig)
