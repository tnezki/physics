#!/usr/bin/env python3
# Universal Bank Finalizer v6.3 SAFE — Physics duplicate/security/figure-answer-neutrality hardened; embeds authoritative MathJax v10 repair engine
...
def _is_secure(item):
    ...
    return bool(item.get('summative_version')) or 'secure' in sec or 'summative' in dest
...
def checks(base,residual_math):
    ...
    if family=='science':
        required_literal={'bank_id','destination','section','student_html','student_text','choices','answer_text','tables','figures','learning_target','i_can','i_can_id','supporting_i_can_ids','mastery_goal_id','evidence_point_id','security_level','dok','question_family_id','variation','source_basis'}
        ...
        for item in items:
            ...
            for fld in ('evidence_point_id','security_level','dok'):
