...
# Unit 2.5 notes figure: distance-time model for speeding up
...
make_context_graph(
    ...
    xlabel='Time (s)', ylabel='Distance from start (m)', title=''
)
save_graph(fig, 'u2_5_distance_time_speeding_up.png')
plt.close(fig)
