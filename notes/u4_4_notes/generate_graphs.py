...
# Unit 4 Section 4.4 energy-account bar charts
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_bar_chart(ax, ['PE', 'KE', 'Thermal'], [80, 20, 0], title='', ylabel='Energy (J)', xlabel='Energy form')
save_graph(fig, 'u4_4_energy_account_a.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_bar_chart(ax, ['PE', 'KE', 'Thermal'], [30, 60, 10], title='', ylabel='Energy (J)', xlabel='Energy form')
save_graph(fig, 'u4_4_energy_account_b.png')
plt.close(fig)
