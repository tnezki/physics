...
# =============================================================================
# UNIT 1 SECTION 1 NOTES GRAPH-GENERATION BLOCKS - APPENDED BELOW AUTHORITATIVE TOOL
# =============================================================================
if __name__ == '__main__':
    ...
    make_scatter_plot(
        ax,
        x_data=[1, 2, 3, 4, 5],
        y_data=[1.40, 1.43, 1.39, 1.42, 1.41],
        xmin=0, xmax=5,
        ymin=1.35, ymax=1.45,
        line_of_best_fit=False,
        xlabel='Trial',
        ylabel='Roll Distance (m)',
        title='Repeated Measurements'
    )
    save_graph(fig, 'u1_s1_notes_repeated_measurements.png')
    plt.close(fig)
