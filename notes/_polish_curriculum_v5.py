...
Folder:
    python polish_curriculum_v5.py /path/to/folder

ZIP:
    python polish_curriculum_v5.py /path/to/package.zip

Single file:
    python polish_curriculum_v5.py /path/to/file.html

Optional MathJax fixer:
    python polish_curriculum_v5.py package.zip --mathjax-fixer fix_mathjax_v5.py
