...
# =============================================================================
# UNIT 1 SECTION 4 NOTES GRAPH-GENERATION BLOCKS - APPENDED BELOW AUTHORITATIVE TOOL
# =============================================================================
if __name__ == '__main__':
    fig, ax = plt.subplots(figsize=(4.5, 3.2))
    make_context_graph(
        ax,
        functions=[{'expr': lambda t: np.full_like(t, 4.0), 'deriv': lambda t: np.zeros_like(t), 'color': 'steelblue'}],
        xmin=0, xmax=6,
        ymin=0, ymax=8,
        xlabel='Time (s)',
        ylabel='Velocity (m/s)',
    ...
    save_graph(fig, 'u1_s4_notes_constant_velocity.png')
    plt.close(fig)
