...
# Unit 1 Section 4 notes graph-generation blocks
# All figures use graph_tool.py functions.

make_rectangle_model([r'$3$'], [r'$2x$', r'$5$'], [[r'$6x$', r'$15$']], 'u1_s4_mn3_area_model.png')
