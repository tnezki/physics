...
# Additional Unit 0B bank graph-generation blocks for warmups.
...
# Additional Unit 0A bank graph-generation blocks for warmups.
...
make_diamond(r'', r'$3$', r'$4$', r'', 'u1_warmup_1_1_1_diamond.png')  # V1+P1 factors 3 and 4
make_diamond(r'$-48$', r'', r'', r'$-2$', 'u1_warmup_1_1_2_diamond.png')  # V2+P2 factors 6 and -8
make_diamond(r'$35$', r'', r'$-7$', r'', 'u1_warmup_1_1_3_diamond.png')  # V3+P4 factors -5 and -7
make_diamond(r'', r'', r'$11$', r'$20$', 'u1_warmup_1_2_1_diamond.png')  # V4+P6 factors 9 and 11
make_diamond(r'$30$', r'$5$', r'', r'', 'u1_warmup_1_2_2_diamond.png')  # V1+P3 factors 5 and 6
make_diamond(r'', r'$-4$', r'', r'$5$', 'u1_warmup_1_2_3_diamond.png')  # V2+P5 factors -4 and 9
make_diamond(r'', r'$-2$', r'$-9$', r'', 'u1_warmup_1_3_1_diamond.png')  # V3+P1 factors -2 and -9
make_diamond(r'$84$', r'', r'$12$', r'', 'u1_warmup_1_3_2_diamond.png')  # V4+P4 factors 7 and 12
make_diamond(r'$14$', r'', r'', r'$9$', 'u1_warmup_1_3_3_diamond.png')  # V1+P2 factors 2 and 7
make_diamond(r'', r'', r'$-3$', r'$7$', 'u1_warmup_1_4_1_diamond.png')  # V2+P6 factors 10 and -3
make_diamond(r'', r'$-4$', r'', r'$-10$', 'u1_warmup_1_4_2_diamond.png')  # V3+P5 factors -4 and -6
make_diamond(r'$-99$', r'$11$', r'', r'', 'u1_warmup_1_4_3_diamond.png')  # V4+P3 factors 11 and -9
make_diamond(r'', r'$1$', r'$12$', r'', 'u1_warmup_1_5_1_diamond.png')  # V1+P1 factors 1 and 12
make_diamond(r'$-8$', r'', r'$8$', r'', 'u1_warmup_1_5_2_diamond.png')  # V2+P4 factors -1 and 8
make_diamond(r'', r'', r'$-7$', r'$-7$', 'u1_warmup_1_5_3_diamond.png')  # V5+P6 factors 0 and -7
