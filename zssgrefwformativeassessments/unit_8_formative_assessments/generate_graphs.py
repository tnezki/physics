...
# =============================================================================
# UNIT 8 FORMATIVE GRAPH-GENERATION BLOCKS — appended after authoritative source
# =============================================================================

def _u8_save_ac(filename, amp, freq, xmax, phase=0.0):
    fig, ax = plt.subplots(figsize=(4.2, 3.2))
    yb = 12 if amp <= 10 else 20
    make_context_graph(ax, [
        {'expr':lambda x, A=amp, f=freq, p=phase: A*np.sin(2*np.pi*f*x+p),
...
_u8_save_ac('u08_dok2_4_v1.png',10,1.0,3.0,0.0)
_u8_save_ac('u08_dok2_4_v2.png',8,0.5,4.0,0.0)
_u8_save_ac('u08_dok2_4_v3.png',12,2.0,2.0,0.0)
_u8_save_ac('u08_dok2_4_v4.png',10,1.0,2.0,-np.pi/2)
_u8_save_ac('u08_dok2_4_v5.png',6,1.0,2.0,0.0)
_u8_save_ac('u08_dok2_4_v6.png',10,0.75,4.0,0.0)
_u8_save_ac('u08_dok2_4_v7.png',9,2.0,1.5,0.0)
_u8_save_ac('u08_dok2_4_v8.png',9,0.5,6.0,0.0)
