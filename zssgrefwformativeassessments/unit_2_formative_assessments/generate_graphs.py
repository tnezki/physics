...
# =============================================================================
# UNIT 2 FORMATIVE GRAPH GENERATION — APPENDED BELOW AUTHORITATIVE SOURCE
# =============================================================================

def _u2_context(filename, expr, deriv, xmin, xmax, ymin, ymax, xlabel, ylabel, title=''):
    fig, ax = plt.subplots(figsize=(5.2, 3.15))
    fig.patch.set_facecolor('white')
    functions=[{'expr':expr,'deriv':deriv,'color':'steelblue','label':None}]
    make_context_graph(ax, functions, xmin, xmax, ymin, ymax, xlabel=xlabel, ylabel=ylabel, title=title)
    save_graph(fig, filename)
    plt.close(fig)

# DOK 2.3 Motion Graph Match-Up
_u2_context('u2_dok2_3_v1.png', lambda t: 3*t, lambda t: np.full_like(t,3.0), 0,8,0,24,'Time (s)','Distance (m)','Graph A')
_u2_context('u2_dok2_3_v2.png', lambda t: 0.7*t**2, lambda t: 1.4*t, 0,6,0,26,'Time (s)','Distance (m)','Graph B')
_u2_context('u2_dok2_3_v3.png', lambda t: 2*t, lambda t: np.full_like(t,2.0), 0,5,0,10,'Time (s)','Velocity (m/s)','Graph C')
_u2_context('u2_dok2_3_v4.png', lambda t: np.full_like(t,5.0), lambda t: np.zeros_like(t), 0,8,0,8,'Time (s)','Velocity (m/s)','Graph D')
_u2_context('u2_dok2_3_v5.png', lambda t: np.where(t<4,2*t,8), lambda t: np.where(t<4,2.0,0.0), 0,8,0,10,'Time (s)','Distance (m)','Graph E')
_u2_context('u2_dok2_3_v6.png', lambda t: np.where(t<2,2*t,np.where(t<5,4,4+3*(t-5))), lambda t: np.where(t<2,2.0,np.where(t<5,0.0,3.0)), 0,8,0,14,'Time (s)','Distance (m)','Graph F')
_u2_context('u2_dok2_3_v7.png', lambda t: 6-2*t, lambda t: np.full_like(t,-2.0), 0,6,-6,8,'Time (s)','Velocity (m/s)','Graph G')
_u2_context('u2_dok2_3_v8.png', lambda t: 8*t-0.5*t**2, lambda t: 8-t, 0,7,0,28,'Time (s)','Distance (m)','Graph H')

# DOK 3.3 Graph/Table/Story consistency
_u2_context('u2_dok3_3_v1.png', lambda t: 2*t, lambda t: np.full_like(t,2.0), 0,4,0,8,'Time (s)','Velocity (m/s)','')
_u2_context('u2_dok3_3_v2.png', lambda t: 4*t, lambda t: np.full_like(t,4.0), 0,6,0,24,'Time (s)','Distance (m)','')
_u2_context('u2_dok3_3_v3.png', lambda t: 2*t**2, lambda t: 4*t, 0,3.5,0,24,'Time (s)','Distance (m)','')
_u2_context('u2_dok3_3_v4.png', lambda t: np.full_like(t,5.0), lambda t: np.zeros_like(t), 0,6,0,8,'Time (s)','Velocity (m/s)','')
_u2_context('u2_dok3_3_v5.png', lambda t: 8-2*t, lambda t: np.full_like(t,-2.0), 0,4,0,9,'Time (s)','Velocity (m/s)','')
_u2_context('u2_dok3_3_v6.png', lambda t: np.where(t<2,3*t,np.where(t<5,6,6+2*(t-5))), lambda t: np.where(t<2,3.0,np.where(t<5,0.0,2.0)), 0,8,0,13,'Time (s)','Distance (m)','')
_u2_context('u2_dok3_3_v7.png', lambda t: 1+2*t, lambda t: np.full_like(t,2.0), 0,3,0,8,'Time (s)','Velocity (m/s)','')
_u2_context('u2_dok3_3_v8.png', lambda t: 8*t-0.5*t**2, lambda t: 8-t, 0,3.5,0,24,'Time (s)','Distance (m)','')

# DOK 4.1 motion-story evidence
_u2_context('u2_dok4_1_v1.png', lambda t: 2+1.5*t, lambda t: np.full_like(t,1.5), 0,6,0,12,'Time (s)','Velocity (m/s)','')
_u2_context('u2_dok4_1_v5.png', lambda t: np.where(t<4,3*t,12), lambda t: np.where(t<4,3.0,0.0), 0,6,0,14,'Time (s)','Distance (m)','')
_u2_context('u2_dok4_1_v8.png', lambda t: 10-2*t, lambda t: np.full_like(t,-2.0), 0,5,0,11,'Time (s)','Velocity (m/s)','')

# DOK 4.2 flawed motion graphs — intentionally flawed evidence; neutral titles/alt text in HTML
_u2_context('u2_dok4_2_v1.png', lambda t: 0.8*t**2, lambda t: 1.6*t, 0,6,0,30,'Time (s)','Distance (m)','Student graph')
_u2_context('u2_dok4_2_v2.png', lambda t: 4*t, lambda t: np.full_like(t,4.0), 0,6,0,24,'Time (s)','Distance (m)','Student graph')
_u2_context('u2_dok4_2_v3.png', lambda t: 3*t, lambda t: np.full_like(t,3.0), 0,8,0,24,'Time (s)','Distance (m)','Student graph')
_u2_context('u2_dok4_2_v4.png', lambda t: 8+1.5*t, lambda t: np.full_like(t,1.5), 0,5,0,16,'Time (s)','Velocity (m/s)','Student graph')
_u2_context('u2_dok4_2_v5.png', lambda t: 10*t, lambda t: np.full_like(t,10.0), 0,4,0,40,'Time (s)','Distance (m)','Student graph')
_u2_context('u2_dok4_2_v6.png', lambda t: np.full_like(t,8.0), lambda t: np.zeros_like(t), 0,8,0,10,'Time (s)','Speed (m/s)','Student graph')
_u2_context('u2_dok4_2_v7.png', lambda t: 0.7*t**2, lambda t: 1.4*t, 0,5,0,18,'Time (s)','Velocity (m/s)','Student graph')
_u2_context('u2_dok4_2_v8.png', lambda t: 6-2*t, lambda t: np.full_like(t,-2.0), 0,5,-5,7,'Time (s)','Velocity (m/s)','Student graph')

# DOK 4.4 model defense
_u2_context('u2_dok4_4_v3.png', lambda t: 10*t, lambda t: np.full_like(t,10.0), 0,4,0,40,'Time (s)','Speed magnitude (m/s)','')
_u2_context('u2_dok4_4_v6.png', lambda t: 6-2*t, lambda t: np.full_like(t,-2.0), 0,6,-6,7,'Time (s)','Velocity (m/s)','')
_u2_context('u2_dok4_4_v8.png', lambda t: np.where(t<3,2*t,np.where(t<5,6,6-2*(t-5))), lambda t: np.where(t<3,2.0,np.where(t<5,0.0,-2.0)), 0,8,-1,8,'Time (s)','Velocity (m/s)','')
